#' @title fetch_sjofartsforetagEuT08092
#' @importFrom magrittr "%>%"
...
#' @export
#'
fetch_sjofartsforetagEuT08092 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/sjofartsforetagEuT08092.csv")
  TABLE_OF_INTEREST <-
