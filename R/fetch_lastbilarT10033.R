...
#' @export
#'
fetch_lastbilarT10033 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/lastbilarT10033.csv")
  TABLE_OF_INTEREST <-
