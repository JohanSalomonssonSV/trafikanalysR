...
#' @export
#'
fetch_personbilarT10094 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/personbilarT10094.csv")
  TABLE_OF_INTEREST <-
