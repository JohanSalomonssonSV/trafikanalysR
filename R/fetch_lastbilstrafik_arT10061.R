#' @title fetch_lastbilstrafik_arT10061
#' @importFrom magrittr "%>%"
...
#' @export
#'
fetch_lastbilstrafik_arT10061 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/lastbilstrafik_arT10061.csv")
  TABLE_OF_INTEREST <-
