#' @title fetch_postverksamhetT0701
#' @importFrom magrittr "%>%"
...
#' @export
#'
fetch_postverksamhetT0701 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/postverksamhetT0701.csv")
  TABLE_OF_INTEREST <-
