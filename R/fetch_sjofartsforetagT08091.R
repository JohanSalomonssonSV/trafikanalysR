#' @title fetch_sjofartsforetagT08091
#' @importFrom magrittr "%>%"
...
#' @export
#'
fetch_sjofartsforetagT08091 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/sjofartsforetagT08091.csv")
  TABLE_OF_INTEREST <-
