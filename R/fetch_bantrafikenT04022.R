...
#' @export
#'
fetch_bantrafikenT04022 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/bantrafikenT04022.csv")
  TABLE_OF_INTEREST <-
