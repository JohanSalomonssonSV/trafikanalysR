#' @title fetch_lastbilstrafik_kvartalT10062
#' @importFrom magrittr "%>%"
...
#' @export
#'
fetch_lastbilstrafik_kvartalT10062 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/lastbilstrafik_kvartalT10062.csv")
  TABLE_OF_INTEREST <-
