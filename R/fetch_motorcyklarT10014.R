...
#' @export
#'
fetch_motorcyklarT10014 <- function(URL, DATA_SELECTION) {
  Comb_selection <-
    readr::read_csv("https://raw.githubusercontent.com/JohanSalomonssonSV/trafikanalysR/master/data/motorcyklarT10014.csv")
  TABLE_OF_INTEREST <-
